...
// ── pi SDK imports ──────────────────────────────────────────────────────────
import { createAgentSession, AuthStorage, SessionManager, SettingsManager, } from "@mariozechner/pi-coding-agent";
// ── Config ──────────────────────────────────────────────────────────────────
...
app.post("/api/session", async (_req, res) => {
    try {
        ...
        const authStorage = AuthStorage.create(path.join(process.env.HOME ?? "/tmp", ".pi/agent/auth.json"));
